const universities = [
    {
        ...
        majors: 
        {
            ...
            kz: ['Халықаралық экономика мектебі', 'Бизнес, менеджмент және құқық', 'Өнер және гуманитарлық ғылымдар', 'Журналистика мектебі'],
        },
        requirements: {
            en: [
            ...
            kz: [
              'Университет басшысының атына өтініш',
              'Жалпы орта, техникалық және кәсіптік, ортадан кейінгі немесе жоғары білім туралы құжат (түпнұсқа)',
              'Жеке басын куәландыратын құжаттың көшірмесі (өтініш берушінің/заңды өкілдердің)',
              'Туу туралы куәлік (18 жасқа толмаған өтініш берушілер үшін)',
              '3x4 өлшемді фото (электронды)',
              'ҰБТ сертификаты',
              'Ведомостан үзінді (арнайы және (немесе) шығармашылық дайындықты талап ететін жоғары білім беру бағдарламаларына түсушілер үшін, оның ішінде "Педагогикалық ғылымдар" білім беру саласында)',
              'Білім грантының берілуі туралы куәлік',
              'Артықшылықты құқықты/квотаны/жеңілдіктерді растайтын құжаттар (мемлекеттік грант иегерлері үшін)',
              '075/у нысанындағы медициналық анықтама (түпнұсқа)',
              'Флюорография суреті (көшірме)',
              '063 нысаны бойынша вакцинация паспорты (көшірме)',
              'Жігіттерге арналған тіркеу куәлігі (көшірме)',
              'Өтініш берушінің (18 жастан асқан) немесе заңды өкілінің ЭЦҚ (электрондық цифрлық қолтаңбасы)',
              'Қалта – 1 дана; Файл – 3 дана'
            ]
        }
    },
    {
        ...
        majors: 
        {
            ...
            kz: ['Педагогикалық ғылымдар', 'Өнер және гуманитарлық ғылымдар', 'Әлеуметтік ғылымдар, журналистика және ақпарат', 'Бизнес, менеджмент және құқық', 'Жаратылыстану ғылымдары, математика және статистика', 'Ақпараттық және коммуникациялық технологиялар', 'Инженерия , өңдеуші және құрылыс индустриясы']
        },
        requirements: {
            en: [
                'Application addressed to the head of the university',
    ...
    },
    {
        ...
        majors: 
        {
            ...
            kz: ['Ақпараттық және коммуникациялық технологиялар', 'Өнер және гуманитарлық ғылымдар', 'Халықаралық экономика мектебі', 'Бизнес, менеджмент және құқық']
        },
        requirements: {
            en: [
                'Application addressed to the head of the university',
